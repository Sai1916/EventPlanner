...
const signUp = () => {
    ...
    const onSignUp = async() => {
      ...
      await account.create(ID.unique(), email, password, name);
        ...
        .then((res) => {
          ...
          router.replace('/home');
        }).catch((error) => {console.log("error inside: " + error)});
    }
  ...
  return (
    <ImageBackground source={bgImage} style={styles.container} blurRadius={2}>    
        ...
        />
      <TextInput placeholder='Name' value={name} onChangeText={e => setName(e)} style={styles.textInput} placeholderTextColor={'black'} cursorColor={'black'}/>
      ...
      <TouchableOpacity style={styles.btn} activeOpacity={0.7} onPress={onSignUp}>   
